...
* rake backup:db - Backup the current database. Timestamped file is created as :rails_root/../db-name-timestamp.sql, accepts format=[custom datetime format string]
